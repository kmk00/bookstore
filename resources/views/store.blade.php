    ...
    <div class="max-w-[2000px] mx-auto md:flex flex-wrap">
        <div x-data="{ showFilter: false }">
            <div class="flex justify-center p-2">
                <button @click="showFilter = !showFilter" class="text-2xl hover:scale-95 transition duration-100 ease-in-out flex flex-col items-center justify-center my-4 font-bold text-center mx-auto">
